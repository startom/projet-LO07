...
function formu_date()
{
	...
	if(date)
		div.innerHTML = '<label for="date1">Date : </label><input type="week" name="date1" id="date1" />';
	else
		div.innerHTML = '<label for="date1">Date de début : </label><input type="week" name="date1" id="date1" />  <label for="date2">Date de fin : </label><input type="week" name="date2" id="date2" />';
